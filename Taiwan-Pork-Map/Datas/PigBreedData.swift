...
let pigBreedHistory: [PigBreedHistory] = [
    ...
    PigBreedHistory(
        pigBreedImage: PigBreedImages.lanyu, pigCategory: "盤克夏",
    ...
    PigBreedHistory(
        pigBreedImage: PigBreedImages.lanyu, pigCategory: "漢布夏",
    ...
    PigBreedHistory(
        pigBreedImage: PigBreedImages.lanyu, pigCategory: "梅山豬",
    ...
    PigBreedHistory(
        pigBreedImage: PigBreedImages.lanyu, pigCategory: "蘭嶼豬",
    ...
    PigBreedHistory(
        pigBreedImage: PigBreedImages.lanyu, pigCategory: "畜試花斑豬",
    ...
    PigBreedHistory(
        pigBreedImage: PigBreedImages.lanyu, pigCategory: "畜試迷彩豬",
    ...
    PigBreedHistory(
        pigBreedImage: PigBreedImages.taiwanBlack, pigCategory: "畜試黑豬一號",
    ...
    PigBreedHistory(
        pigBreedImage: PigBreedImages.leeSungStrainPig, pigCategory: "李宋品系豬",
    ...
    PigBreedHistory(
        pigBreedImage: PigBreedImages.tlriBlackNo1, pigCategory: "賓朗豬",
